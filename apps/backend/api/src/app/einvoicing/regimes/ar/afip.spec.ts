...
describe('AFIP — WSFEv1', () => {
  ...
  describe('the request', () => {
    ...
    it.each([
      ['el emisor sin CUIT', { organization: { ...organization, taxId: '123' } as unknown as Organization }, 'einvoicing.organization_has_no_valid_cuit_afip'],
      ['sin punto de venta', { salesPoint: 0 }, 'einvoicing.point_sale_afip_assigned_establishment_missing'],
      ['sin número de comprobante', { nextNumber: 0 }, 'einvoicing.document_number_afip_expects_next_missing'],
