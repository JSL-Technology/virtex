...
describe('DIAN — factura electrónica', () => {
  ...
  describe('the UBL document', () => {
    ...
    it.each([
      ['el emisor sin NIT', { organization: { ...organization, taxId: null } as unknown as Organization }, 'einvoicing.co.organization_has_no_nit_electronic_invoice'],
      ['el receptor sin documento', { customer: { ...customer, taxId: null } as unknown as Customer }, 'einvoicing.co.customer_customer_has_no_identification_document'],
      ['sin clave técnica', { technicalKey: '' }, 'einvoicing.co.invoicing_resolution_technical_key_missing_cufe'],
