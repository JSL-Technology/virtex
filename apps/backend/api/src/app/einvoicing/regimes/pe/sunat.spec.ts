...
describe('SUNAT — comprobante de pago electrónico', () => {
  ...
  it.each([
    ['el emisor sin RUC', { organization: { ...organization, taxId: null } as unknown as Organization }, 'einvoicing.organization_has_no_ruc_sunat_does'],
    ['sin serie', { series: '' }, 'einvoicing.document_series_missing_f001_example'],
