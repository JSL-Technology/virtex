 ...
 *
 * There was no client service at all. Fourteen HCM endpoints — the register, the encrypted fiscal
 * identity, the versioned pay history, the departments — were reachable only with a REST client,
 * while the screen in the product was a placeholder reading "Employee records, payroll, and
 * performance management" over an empty page.
 */
