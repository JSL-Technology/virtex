 ...
 * Payroll.
 *
 * There was no client service. Twenty-two endpoints — the run lifecycle, its variable inputs, the
 * payslips, the concept catalogue, the statutory parameters and the three TSS filings — were
 * reachable only with a REST client, while the product's only HR screen was a placeholder with a
