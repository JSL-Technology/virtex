...
const mockUsers: any[] = [
  { id: '1', firstName: 'John', lastName: 'Doe', email: 'john@doe.com', status: UserStatus.ACTIVE, roles: [{id: '1', name: 'Admin', permissions: [], description: '', isSystemRole: false}], organizationId: '1', isOnline: true, createdAt: new Date() },
  { id: '2', firstName: 'Jane', lastName: 'Doe', email: 'jane@doe.com', status: UserStatus.PENDING, roles: [{id: '2', name: 'User', permissions: [], description: '', isSystemRole: false}], organizationId: '1', isOnline: false, createdAt: new Date() },
];

const mockRoles: Role[] = [
    { id: '1', name: 'Admin', permissions: [], description: '', isSystemRole: false },
    { id: '2', name: 'User', permissions: [], description: '', isSystemRole: false },
]
